...
export default async function Home() {
  ...
  const heroProps = {
    ...
    ctaText: c.hero?.ctaText || 'Zacznij 7 dni za darmo',
    ctaUrl: '/checkout',
    videoMediaId: videoData.mediaId,
    videoAspectRatio: videoData.aspectRatio,
    trialInfo: c.hero?.trialInfo,
    trialBadge: c.hero?.trialBadge,
    trialDetails: c.hero?.trialDetails,
    earlyBirdLabel: c.hero?.earlyBirdLabel,
    earlyBirdPrice: c.hero?.earlyBirdPrice,
    earlyBirdRegularPrice: c.hero?.earlyBirdRegularPrice,
    earlyBirdPriceSuffix: c.hero?.earlyBirdPriceSuffix,
    ctaSubline: c.hero?.ctaSubline,
